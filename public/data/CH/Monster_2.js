...
var _monster_2 = {
    ...
    "100201501": {
        ...
        "Name": "冰锋（幻象）",
        "Desc": "守护者创造的巨大冰矛，能释放出席卷全场的刺骨霜风。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 1.5,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "100201702": {
        ...
        "Name": "无尽寒冬之槊（幻象）",
        "Desc": "可可利亚召唤出的巨大冰矛，环绕着能如刀刃般撕裂肉身的极寒气流。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 2.25,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "100203012": {
        ...
        "Key": "Monster_W1_Soldier04_00_Config",
        "Name": "银鬃炮手（幻象）",
        "Desc": "银鬃铁卫中的炮手，使用便携的手炮进行战斗。<br> 在战斗中，银鬃炮手会和其它目标发动猛烈的连携攻击。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 2.1,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "101201008": {
        ...
        "Key": "Monster_W1_Mecha02_00_Config",
        "Name": "失真",
        "Desc": "「记忆」和「照片」很相似。它看似记录了「真实」，但却在侵入「真实」、异化「真实」、篡改「真实」。也许清除其中的「失真」会使它变得可靠，也许不会。",
        "Stats": {
            "HP": 1.4,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "101401006": {
        ...
        "Key": "Monster_W1_Svarog_00_Config",
        "Name": "「监督机器」原型机2号",
        "Desc": "旧世界的古老遗物，地髓开拓团的时代遗留下的自动控制单元。与大部分无智、只接受指令的机器不同，「监督机器」具有复杂的思考能力。<br>在战斗中，「监督机器」能召唤各种类型的机械并操控机械臂抓取和控制敌人，对目标进行沉重的打击。",
        "Stats": {
            "HP": 22.0,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "200202003": {
        ...
        "Key": "Monster_W2_Yanqing_01_Config",
        "Name": "飞剑（幻象）",
        "Desc": "真气操作浮游攻击单元，别名「飞剑」的武器。同御剑者心智紧密相连，如臂使指。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 30.0,
            "ATK": 19.99998,
            "DEF": 1.0,
    ...
    "201201001": {
        ...
        "Name": "格律诗人",
        "Desc": "由小聪打造的「格律诗人」。<br>内置「灵感玉兆」，搜集诗体格式，节奏音律等素材，用于辅助诗歌格律的创作。",
        "Stats": {
            "HP": 1.5,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "201301001": {
        ...
        "Name": "边塞诗人",
        "Desc": "由小聪打造的「边塞诗人」。<br>内置「灵感玉兆」，搜集军旅生涯、豪情壮志等素材，用于「边塞诗」的类型创作。",
        "Stats": {
            "HP": 10.0,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "202202005": {
        ...
        "Key": "Monster_W2_Abomi02_00_Config",
        "Name": "不速之客",
        "Desc": "怀抱恶意的来者，以铲除丹枫转世之身为名，前来刺杀丹恒。",
        "Stats": {
            "HP": 1.2,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "202207101": {
        ...
        "Name": "肃风之杪（幻象）",
        "Desc": "随玄鹿足迹而生的建木枝梢。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 1.6,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "202302002": {
        ...
        "Key": "Monster_W2_Beast02_00_Config",
        "Name": "幻胧",
        "Desc": "崇信丰饶的秘密组织「药王秘传」信徒渴求的形态，摆脱人性重负，以仙道重塑的真体。<br>太古时代，求道者们自建木中参悟玄旨，自诩「仙人」。他们自在无拘，将血肉众生如泥塑形。在无数次变化间，他们忘却了自己的本来面目。",
        "Stats": {
            "HP": 9.0,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "300201003": {
        ...
        "Key": "Monster_W3_TV_00_Config",
        "Name": "柯柯娜的纯真",
        "Desc": "纯真之心，曾相信这世界无论有多少苦难，结局终是美好的。",
        "Stats": {
            "HP": 2.75,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "803201003": {
        ...
        "Key": "Monster_W1_Soldier02_01_Config",
        "Name": "基层员工 · 外勤（幻象）",
        "Desc": "「星际和平公司」的基层员工，主要负责处理上不得台面的「业务疏漏」。工资不高，只能在公司旗下的企业舰上合租房间。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 1.6,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "803202003": {
        ...
        "Key": "Monster_W1_Soldier01_04_Config",
        "Name": "基层员工 · 安保（幻象）",
        "Desc": "「星际和平公司」的基层员工，主要负责维持公司管辖地区的治安秩序。工资不高，只能在公司旗下的企业舰上合租房间。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 2.2,
            "ATK": 18.0,
            "DEF": 1.0,
    ...
    "803301002": {
        ...
        "Key": "Monster_W1_Mecha03_02_Config",
        "Name": "资深员工 · 组长（幻象）",
        "Desc": "「星际和平公司」的资深员工，级别至少是项目组的小组长。驾驶的机甲属于公有资产，一旦损坏需要自费赔偿。工资尚可，足够在公司旗下的企业舰上租下一室一厅的单间。出现于此的是基于你的记忆模拟出的幻影。",
        "Stats": {
            "HP": 6.0,
            "ATK": 18.0,
            "DEF": 1.0,
