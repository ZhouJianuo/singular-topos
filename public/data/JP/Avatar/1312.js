...
var _avatarskill_ = {
    "131201": {
        "v5": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Ice DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Misha's ATK to a single target enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "131202": {
        "v5": {
            ...
            "Type": "Skill",
            "Tag": "Blast",
            "Desc": "Increases the Hits Per Action for Misha's next Ultimate by <b>#3[f]</b> hit(s). Deals Ice DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Misha's ATK to a single target enemy, and Ice DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Misha's ATK to adjacent targets.",
            "Params": [
                [
                    1.0,
                    0.4,
    ...
    "131203": {
        ...
        "Live": {
            ...
            "Type": "Ultimate",
            "Tag": "Bounce",
            "Desc": "Has <b>#1[f]</b> Hits Per Action by default. First, uses 1 hit to deal Ice DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Misha's ATK to a single target enemy. Then, the rest of the hits each deals Ice DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Misha's ATK to a single random enemy. Just before each hit lands, there is a <color style='color:#f29e38;'><b>#3[p]</b></color> <u>base chance</u> to Freeze the target, lasting for 1 turn.<br>While Frozen, enemy targets cannot take any actions, and at the start of their turn, they receive <u>Additional Ice DMG</u> equal to <color style='color:#f29e38;'><b>#4[p]</b></color> of Misha's ATK.<br>This Ultimate can possess up to <b>#5[f]</b> Hits Per Action. After the Ultimate is used, its Hits Per Action will be reset to the default level.<br><br><color style='color:#f29e38;'><b>Additional DMG</b></color><br>Causes the target being hit to take extra DMG, which is not considered an attack.",
            "Params": [
                [
                    3.0,
                    0.36,
    ...
    "131204": {
        "v5": {
            ...
            "Type": "Talent",
            "Tag": "Enhance",
            "Desc": "Whenever any ally consumes 1 Skill Point, Misha's next Ultimate delivers <b>#2[f]</b> more Hits Per Action and Misha regenerates <color style='color:#f29e38;'><b>#1[f]</b></color> Energy.",
            "Params": [
                [
                    1.0,
                    1.0
        ...
        "Live": {
            ...
            "Type": "Talent",
            "Tag": "Enhance",
            "Desc": "For every 1 Skill Point allies consume, Misha's next Ultimate delivers <b>#2[f]</b> more Hit(s) Per Action and Misha regenerates <color style='color:#f29e38;'><b>#1[f]</b></color> Energy.",
            "Params": [
                [
                    1.0,
                    1.0
    ...
    "131207": {
        "v5": {
            ...
            "Type": "Technique",
            "Tag": "Impair",
            "Desc": "After using the Technique, creates a dimension that lasts for <b>#1[f]</b> seconds. Enemies caught in the dimension are inflicted with Dream Prison and stop all their actions. Upon entering battle against enemies afflicted with Dream Prison, increases the Hits Per Action for Misha's next Ultimate by <b>#2[f]</b> hit(s). Only 1 dimension created by allies can exist at the same time.",
            "Params": [
                [
                    15.0,
                    2.0
...
var _avatarskilltree_ = {
    "1312": {
        "v5": {
            ...
            "Tree1": {
                "Name": "Release",
                "Desc": "Before the Ultimate's first hit lands, increases the base chance of Freezing the target by <b><color style='color:#f29e38'>80.0%</color></b>.",
                "Icon": "SkillIcon_1312_SkillTree1"
            },
            "Tree2": {
                "Name": "Interlock",
                "Desc": "When using the Ultimate, increases the Effect Hit Rate by <b><color style='color:#f29e38'>60.0%</color></b>, lasting until the end of the Ultimate's current action.",
                "Icon": "SkillIcon_1312_SkillTree2"
            },
            "Tree3": {
                "Name": "Transmission",
                "Desc": "When dealing DMG to Frozen enemies, increases CRIT DMG by <b><color style='color:#f29e38'>30.0%</color></b>.",
        ...
        "Live": {
            ...
            "Tree2": {
                "Name": "Interlock",
                "Desc": "When using the Ultimate, increases the Effect Hit Rate by <b><color style='color:#f29e38'>60.0%</color></b>, lasting until the end of the current Ultimate's action.",
                "Icon": "SkillIcon_1312_SkillTree2"
            },
            "Tree3": {
                "Name": "Transmission",
...
var _avatarrank_ = {
    "131201": {
        "v5": {
            ...
            "Desc": "When using the Ultimate, for every enemy on the field, additionally increases the Hits Per Action for the Ultimate by <b><color style='color:#f29e38'>1.0</color></b> hit(s), up to a maximum increase of <b><color style='color:#f29e38'>5.0</color></b> hit(s).",
            "Icon": "SkillIcon_1312_Rank1"
        },
        "Live": {
            "Rank": 1,
            "Name": "Whimsicality of Fancy",
            "Desc": "When using the Ultimate, for every enemy on the field, additionally increases the Hits Per Action for the current Ultimate by <b><color style='color:#f29e38'>1.0</color></b> hit(s), up to a maximum increase of <b><color style='color:#f29e38'>5.0</color></b> hit(s).",
            "Icon": "SkillIcon_1312_Rank1"
        }
    },
    "131202": {
        "v5": {
            ...
            "Desc": "Before each hit of the Ultimate lands, there is a <b><color style='color:#f29e38'>24.0%</color></b> base chance of reducing the target's DEF by <b><color style='color:#f29e38'>16.0%</color></b> for <b><color style='color:#f29e38'>3.0</color></b> turn(s).",
    ...
    "131204": {
        "v5": {
            ...
            "Desc": "Increases the DMG multiplier for each hit of the Ultimate by <b><color style='color:#f29e38'>6.0%</color></b>.",
    ...
    "131206": {
        "v5": {
            ...
            "Desc": "When using the Ultimate, increases own DMG by <b><color style='color:#f29e38'>30.0%</color></b>, lasting until the end of the turn. In addition, the next time the Skill is used, recovers <b><color style='color:#f29e38'>1.0</color></b> Skill Point(s) for the team.",
