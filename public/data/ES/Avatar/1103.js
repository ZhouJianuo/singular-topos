...
var _avatarskill_ = {
    "110301": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Lightning DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Serval's ATK to a single enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "110303": {
        "Pre": {
            ...
            "Type": "Ultimate",
            "Tag": "AoE",
            "Desc": "Deals Lightning DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Serval's ATK to all enemies. Enemies already Shocked will extend the duration of their Shock state by <b>#2[f]</b> turn(s).",
            "Params": [
                [
                    1.08,
                    2.0
    ...
    "110304": {
        "Pre": {
            ...
            "Type": "Talent",
            "Tag": "Enhance",
            "Desc": "After Serval attacks, deals <u>Additional</u> Lightning DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Serval's ATK to all Shocked enemies.",
            "Params": [
                [
                    0.36
                ],
    ...
    "110307": {
        "Pre": {
            ...
            "Type": "Technique",
            "Tag": "",
            "Desc": "Immediately attacks the enemy. After entering battle, deals Lightning DMG equal to <b>#4[p]</b> of Serval's ATK to a random enemy, with a <b>#1[p]</b> <u>base chance</u> for all enemies to become Shocked for <b>#3[f]</b> turn(s).<br>While Shocked, enemies will take Lightning DoT equal to <b>#2[p]</b> of Serval's ATK at the beginning of each turn.",
            "Params": [
                [
                    1.0,
                    0.5,
...
var _avatarskilltree_ = {
    "1103": {
        "Pre": {
            ...
            "Tree1": {
                "Name": "Rock 'n' Roll",
                "Desc": "Skill has a <b><color style='color:#f29e38'>20.0%</color></b> increased base chance to Shock enemies.",
            ...
            "Tree3": {
                "Name": "Mania",
                "Desc": "Upon defeating an enemy, ATK is increased by <b><color style='color:#f29e38'>20.0%</color></b> for <b><color style='color:#f29e38'>2.0</color></b> turn(s).",
...
var _avatarrank_ = {
    "110301": {
        "Pre": {
            "Rank": 1,
            "Name": "Echo Chamber",
            "Desc": "Basic ATK deals Lightning DMG equal to <b><color style='color:#f29e38'>60.0%</color></b> of the Basic ATK's DMG to a random enemy adjacent to the target of the Basic ATK.",
    ...
    "110302": {
        "Pre": {
            "Rank": 2,
            "Name": "Encore!",
            "Desc": "Every time Serval's Talent is triggered to deal Additional DMG, she regenerates <b><color style='color:#f29e38'>4.0</color></b> Energy.",
    ...
    "110304": {
        "Pre": {
            ...
            "Desc": "Ultimate has a <b><color style='color:#f29e38'>100.0%</color></b> base chance to apply Shock to any enemies not currently Shocked. This Shock has the same effects as the one applied by Skill.",
    ...
    "110306": {
        "Pre": {
            ...
            "Desc": "Serval deals <b><color style='color:#f29e38'>30.0%</color></b> more DMG to Shocked enemies.",
