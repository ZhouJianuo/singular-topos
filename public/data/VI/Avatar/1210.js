...
var _avatarskill_ = {
    "121001": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Fire DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Guinaifen's ATK to a single enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "121002": {
        "Pre": {
            ...
            "Type": "Skill",
            "Tag": "Blast",
            "Desc": "Deals Fire DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Guinaifen's ATK to a single enemy and Fire DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Guinaifen's ATK to any adjacent enemies, with a <b>#3[p]</b> <u>base chance</u> to Burn the target and adjacent targets. When Burned, enemies will take a Fire DoT equal to <color style='color:#f29e38;'><b>#4[p]</b></color> of Guinaifen's ATK at the beginning of each turn, lasting for <b>#5[f]</b> turn(s).",
            "Params": [
                [
                    0.6,
                    0.2,
    ...
    "121003": {
        "Pre": {
            ...
            "Type": "Ultimate",
            "Tag": "AoE",
            "Desc": "Deals Fire DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Guinaifen's ATK to all enemies. If the target enemy is currently inflicted with Burn, then their Burn status immediately produces DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of their original DMG.",
            "Params": [
                [
                    0.72,
                    0.72
    ...
    "121004": {
        "Pre": {
            ...
            "Type": "Talent",
            "Tag": "Impair",
            "Desc": "When Guinaifen is on the field, there is a <b>#1[p]</b> <u>base chance</u> to apply Firekiss to an enemy after their Burn status causes DMG. While inflicted with Firekiss, the enemy receives <color style='color:#f29e38;'><b>#4[p]</b></color> increased DMG, which lasts for <b>#5[f]</b> turn(s) and can stack up to <b>#6[f]</b> time(s).<br>Hidden Stat: #2[f]<br>Hidden Stat: #3[f]",
            "Params": [
                [
                    1.0,
                    0.0,
    ...
    "121007": {
        "Pre": {
            ...
            "Type": "Technique",
            "Tag": "",
            "Desc": "Immediately attacks the enemy. After entering battle, deals DMG for <b>#2[f]</b> time(s), dealing Fire DMG equal to <b>#1[p]</b> of Guinaifen's ATK to a random single enemy target each time, with a <b>#3[p]</b> <u>base chance</u> of inflicting Firekiss on them.",
            "Params": [
                [
                    0.5,
                    4.0,
...
var _avatarskilltree_ = {
    "1210": {
        "Pre": {
            ...
            "Tree1": {
                "Name": "High Poles",
                "Desc": "Basic ATK has a <b><color style='color:#f29e38'>80.0%</color></b> base chance of inflicting an enemy with a Burn, equivalent to that of Skill.",
                "Icon": "SkillIcon_1210_SkillTree1"
            },
            "Tree2": {
                "Name": "Bladed Hoop",
                "Desc": "When the battle begins, Guinaifen's action is advanced forward by <b><color style='color:#f29e38'>25.0%</color></b>.",
                "Icon": "SkillIcon_1210_SkillTree2"
            },
            "Tree3": {
                "Name": "Walking on Knives",
                "Desc": "Deals <b><color style='color:#f29e38'>20.0%</color></b> more DMG to Burned enemies.",
...
var _avatarrank_ = {
    "121001": {
        "Pre": {
            ...
            "Desc": "When Skill is used, there is a <b><color style='color:#f29e38'>100.0%</color></b> base chance to reduce the attacked target enemy's Effect RES by <b><color style='color:#f29e38'>10.0%</color></b> for <b><color style='color:#f29e38'>2.0</color></b> turn(s).",
    ...
    "121002": {
        "Pre": {
            ...
            "Desc": "When an enemy target is being Burned, the DMG multiplier of the Burn status applied by her Basic ATK or Skill increases by <b><color style='color:#f29e38'>40.0%</color></b>.",
    ...
    "121004": {
        "Pre": {
            ...
            "Desc": "Every time the Burn status inflicted by Guinaifen causes DMG, Guinaifen regenerates <b><color style='color:#f29e38'>2.0</color></b> Energy.",
    ...
    "121006": {
        "Pre": {
            ...
            "Desc": "Increases the stackable Firekiss count by <b><color style='color:#f29e38'>1.0</color></b>.",
