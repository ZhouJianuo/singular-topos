...
var _monsterskill = {
    ...
    "803401004": {
        ...
        "Desc": {
            "CH": "召唤<color style='color:#f29e38;'>「所有或一无所有」</color>并使我方单体进入赌局，同时自身获得一个随机 1~9 的点数。<br>每个「所有或一无所有」每次受到进入赌局的我方目标攻击时，会使其获得一个随机 1~6 的点数。<br>进入赌局的我方单体回合结束时，点数低于诡弈砂金视为输掉赌局并承受<color style='color:#f29e38;'>【败者退席】</color>技能；点数高于诡弈砂金视为赢得赌局获得一个额外回合并使我方恢复 <color style='color:#f29e38;'>1</color> 个战技点。",
            "EN": "Summons <color style='color:#f29e38;'>All or Nothing</color> and makes a single target enter the gamble, and chooses a random number for himself between 1 and 9. <br>Every time an All or Nothing is attacked by a target that is in the gamble, the target will receive a random number between 1 and 6.<br>After a target that is in the gamble has finished their turn, targets with numbers lower than Aventurine of Stratagems are considered to have lost the bet and will suffer from the skill <color style='color:#f29e38;'>The Loser's Time Is Over</color>, while those with a number higher than Aventurine of Stratagems are considered to have won the bet and will receive 1 extra turn and recovers <color style='color:#f29e38;'>1</color> Skill Point for the team."
        },
        "SP": 0,
        "Threat": true
    },
    "803401005": {
        ...
        "Desc": {
            "CH": "召唤<color style='color:#f29e38;'>「所有或一无所有」</color>并使我方全体进入赌局，同时自身获得一个随机 1~9 的点数。<br>每个「所有或一无所有」每次受到攻击时，会使进行攻击的我方目标获得一个随机 1~6 的点数。<br>下次诡弈砂金行动时，对点数低于诡弈砂金的我方目标施放<color style='color:#f29e38;'>【胜者通杀】</color>技能；点数高于诡弈砂金的我方目标视为赢得赌局获得一个额外回合并使我方恢复 <color style='color:#f29e38;'>1</color> 个战技点。",
            "EN": "Summons <color style='color:#f29e38;'>All or Nothing</color> and makes all targets enter the gamble, and chooses a random number for himself between 1 and 9.<br>Every time an All or Nothing is attacked, the target that launched the attack will receive a random number between 1 and 6.<br>The next time Aventurine of Stratagems takes a turn, will unleash <color style='color:#f29e38;'>The Winner Takes It All</color> on targets with numbers lower than Aventurine of Stratagems. Targets with numbers higher than Aventurine of Stratagems are considered to have won the bet and will receive 1 extra turn and recovers <color style='color:#f29e38;'>1</color> Skill Point for the team."
        },
        "SP": 0,
        "Threat": true
    },
