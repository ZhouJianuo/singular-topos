...
var _monsterskill = {
    ...
    "100201101": {
        "Key": "Skill04",
        "Name": "Icy Wind",
        "Desc": "Deals <1> Ice DMG to all targets.",
        "SP": 10.0,
        "Elem": "Ice",
        "DMG": [
            2.0
    ...
    "100203001": {
        "Key": "Skill01",
        "Name": "Barrage",
        "Desc": "Deals <1> Physical DMG to a single target and <2> Physical DMG to adjacent units.",
        "SP": 10.0,
        "Elem": "Phys",
        "DMG": [
            1.3,
    ...
    "100401106": {
        ...
        "Desc": "Deals <1> Ice DMG to Frozen targets and <2> Ice DMG to adjacent units. This also removes the target's Frozen state. If the adjacent units are also Frozen, then this ability is used again on the primary target.",
        "SP": 10.0,
        "Elem": "Ice",
        "DMG": [
            3.75,
    ...
    "100403001": {
        ...
        "Desc": "Deals <1> Wind DMG to a single target.",
        "SP": 10.0,
        "Elem": "Wind",
        "DMG": [
            3.0
    ...
    "100403002": {
        ...
        "Desc": "Dispels all debuffs on an ally, and causes them to take action immediately. Cannot be used on herself.",
        "SP": 0
    },
    "100403003": {
        "Key": "Skill03",
    ...
    "100501007": {
        ...
        "Desc": "Deals <1> Imaginary DMG to all targets.",
        "SP": 20.0,
        "Elem": "Imaginary",
        "Threat": true,
        "DMG": [
    ...
    "101202003": {
        ...
        "Desc": "Self-destructs, dealing <1> Fire DMG to a single target and units adjacent to the target.",
        "SP": 15.0,
        "Elem": "Fire",
        "Threat": true,
        "DMG": [
    ...
    "101203001": {
        ...
        "Desc": "Deals <1> Physical DMG to a single target, and grants a Barrier to another friendly unit. The Barrier nullifies all DMG received except for DoT until after the friendly unit is attacked.",
        "SP": 15.0,
        "Elem": "Phys",
        "DMG": [
            3.0
    ...
    "101204006": {
        ...
        "Desc": "The Auxiliary Robot Arm explodes, dealing <1> Physical DMG to a single target.",
        "SP": 25.0,
        "Elem": "Phys",
        "Threat": true,
        "DMG": [
    ...
    "101401005": {
        "Key": "Skill05",
        "Name": "Controlled Blasting",
        "Desc": "The Auxiliary Robot Arm Unit explodes, dealing <1> Physical DMG to a single target.",
        "SP": 25.0,
        "Elem": "Phys",
        "DMG": [
            15.0
    ...
    "102301002": {
        ...
        "Desc": "Deals <1> Fire DMG to a single target and <2> Fire DMG to adjacent units. This attack prioritizes targets afflicted with Burn.",
        "SP": 15.0,
        "Elem": "Fire",
        "DMG": [
            4.0,
    ...
    "102301005": {
        ...
        "Desc": "Deals <1> Fire DMG to all targets. Targets suffering from Burn are dealt an extra <2> Fire DMG and have Burn removed.",
        "SP": 10.0,
        "Elem": "Fire",
        "Threat": true,
        "DMG": [
    ...
    "102301106": {
        ...
        "Desc": "Deals <1> Fire DMG to all targets. Burned target will explode, subsequently dealing <2> Fire DMG to the Burned target and <3> Fire DMG to adjacent units. The central unit's Burn status will be removed.",
        "SP": 10.0,
        "Elem": "Fire",
        "Threat": true,
        "DMG": [
    ...
    "202202002": {
        ...
        "Desc": "Deals <1> Lightning DMG to a single target.",
        "SP": 10.0,
        "Elem": "Elec",
        "DMG": [
            2.5
    ...
    "202202003": {
        "Key": "PassiveSkill01",
        "Name": "Core Rupture",
        "Desc": "Upon receiving a killing blow, deals <1> Lightning DMG to any targets that were inflicted with Spur of Thunderwoe by them. Afterward, Spur of Thunderwoe on these targets will be removed.",
        "SP": 15.0,
        "Elem": "Elec",
        "Status": [
            220220204
    ...
    "202301002": {
        ...
        "Desc": "Deals <1> Lightning DMG to a single target and units adjacent to the target.",
        "SP": 10.0,
        "Elem": "Elec",
        "DMG": [
            3.0
    ...
    "201301003": {
        "Key": "Skill02",
        "Name": "Restraint",
        "Desc": "Deals <1> Imaginary DMG to a single target.",
        "SP": 10.0,
        "Elem": "Imaginary",
        "DMG": [
            3.0
    ...
    "200401003": {
        ...
        "Desc": "Deals <1> Lightning DMG to all targets.",
        "SP": 15.0,
        "Elem": "Elec",
        "DMG": [
            2.5
    ...
    "200401006": {
        "Key": "Skill06",
        "Name": "Cruelty",
        "Desc": "When friendly units (apart from Kafka) or Dominated targets deal DMG to Shocked targets, deal an extra <1> Lightning DMG. This can only be triggered 1 time per turn.",
        "SP": 10.0,
        "Elem": "Elec",
        "DMG": [
            1.0
    ...
    "200402004": {
        ...
        "Desc": "Deals <1> Ice DMG to a single target and <2> Ice DMG to adjacent units.",
        "SP": 10.0,
        "Elem": "Ice",
        "DMG": [
            4.0,
    ...
    "202401006": {
        "Key": "Skill06",
        "Name": "Caress of Wind",
        "Desc": "Deals <1> Wind DMG to all targets.",
        "SP": 15.0,
        "Elem": "Wind",
        "DMG": [
            2.8
    ...
    "800101001": {
        "Key": "Skill01",
        "Name": "Distract",
        "Desc": "Deals <1> Fire DMG to a single target.",
        "SP": 10.0,
        "Elem": "Fire",
        "DMG": [
            2.5
    ...
    "800301106": {
        "Key": "Skill06",
        "Name": "Freeze Burst",
        "Desc": "Deals <1> Ice DMG to Frozen targets. This also removes their Frozen state and deals <2> Ice DMG to their adjacent units.",
        "SP": 15.0,
        "Elem": "Ice",
        "Threat": true,
        "DMG": [
    ...
    "800303007": {
        ...
        "Desc": "Deals <1> Lightning DMG to whoever violates the ban.",
        "SP": 10.0,
        "Elem": "Elec",
        "DMG": [
            3.5
    ...
    "801101001": {
        "Key": "Skill01",
        "Name": "Obliterate",
        "Desc": "Deals <1> Quantum DMG to a single target.",
        "SP": 10.0,
        "Elem": "Quantum",
        "DMG": [
            2.5
    ...
    "801201002": {
        "Key": "Skill02",
        "Name": "Vortex Leap",
        "Desc": "Deals <1> Imaginary DMG to a single target and units adjacent to the target.",
        "SP": 5.0,
        "Elem": "Imaginary",
        "DMG": [
            1.5
    ...
    "801301003": {
        "Key": "Skill03",
        "Name": "War Trample",
        "Desc": "Deals <1> Quantum DMG to a single target and units adjacent to the target.",
        "SP": 10.0,
        "Elem": "Quantum",
        "DMG": [
            2.5
    ...
    "801502009": {
        "Key": "Skill09",
        "Name": "Furor",
        "Desc": "Deals <1> Imaginary DMG to a single target and <2> Imaginary DMG to adjacent targets.",
        "SP": 25.0,
        "Elem": "Imaginary",
        "DMG": [
            3.0,
    ...
    "801314106": {
        "Key": "Skill12",
        "Name": "Impending Doom",
        "Desc": "Deals <1> Quantum DMG to all targets.",
        "SP": 15.0,
        "Elem": "Quantum",
        "Threat": true,
        "DMG": [
    ...
    "202204002": {
        "Key": "SkillP01",
        "Name": "Rebound Roar",
        "Desc": "Upon receiving a killing blow, causes adjacent friendly units to act immediately.",
        "SP": 0
    },
    "202205001": {
        "Key": "Skill01",
    ...
    "200402108": {
        ...
        "Desc": "Deals <1> Ice DMG to a target. For every Flying Sword on field, deal an extra <2> Ice DMG. After using this ability, remove all Flying Swords on the field.",
        "SP": 15.0,
        "Elem": "Ice",
        "Threat": true,
        "DMG": [
    ...
    "202301102": {
        "Key": "Skill02",
        "Name": "Punishing Bolts",
        "Desc": "Deals <1> Lightning DMG to a single target and adjacent units.",
        "SP": 10.0,
        "Elem": "Elec",
        "DMG": [
            3.0
    ...
    "300201004": {
        ...
        "Desc": "Initially, has the Fright Channel status.<br>After being attacked, switch from the Surprise Channel status to the Fright Channel status, or vice versa.",
        "SP": 0
    },
    "802203001": {
        "Key": "Skill01",
    ...
    "300301002": {
        "Key": "Skill02",
        "Name": "Tornado Toss",
        "Desc": "Deals <1> Fire DMG to a single target and <2> Fire DMG to adjacent units.",
        "SP": 10.0,
        "Elem": "Fire",
        "DMG": [
            2.8,
    ...
    "300205003": {
        ...
        "Desc": "When this unit is Weakness Broken, it will leave the battle. When attacked, a Weakness corresponding to the attack's Type will be implanted, up to 2 Weaknesses.",
        "SP": 0
    },
    "101301403": {
        "Key": "Skill05",
    ...
    "301201001": {
        ...
        "Desc": "Shapeshift into other friendly units and copies their abilities. After shapeshifting, this unit's Base Stats is inherited.",
        "SP": 0
    },
    "301201002": {
        "Key": "Skill02",
    ...
    "201302004": {
        "Key": "Skill04",
        "Name": "Heaven's Fall",
        "Desc": "Deals <1> Physical DMG to a single target. If the target is afflicted with Strong Reverberation, they take additional <2> Physical DMG, and Strong Reverberation is then dispelled.",
        "SP": 20.0,
        "Elem": "Phys",
        "Threat": true,
        "Status": [
    ...
    "201302104": {
        "Key": "Skill04",
        "Name": "Heaven's Fall",
        "Desc": "Deals <1> Physical DMG to a single target. If the target is suffering from Strong Reverberation, they take additional <2> Physical DMG, and Strong Reverberation is then dispelled.",
        "SP": 20.0,
        "Elem": "Phys",
        "Threat": true,
        "Status": [
    ...
    "300205103": {
        "Key": "SkillP01",
        "Name": "The Can's Creed",
        "Desc": "When this unit's Weakness is Broken, Weakness will be Broken for all friendly units except Lordly Trashcan (Projection). At the same time, this unit will exit the battle. When attacked, a Weakness corresponding to the attack's Type will be implanted.",
        "SP": 0
    },
    "301402101": {
        "Key": "Skill01",
    ...
    "301301001": {
        ...
        "Desc": "Deals <1> Quantum DMG to a single target and gains 1 stack of Obscure Blaze.",
        "SP": 10.0,
        "Elem": "Quantum",
        "DMG": [
            3
    ...
    "301301003": {
        ...
        "Desc": "Deals <1> Quantum DMG to all targets and gains 1 stack of Obscure Blaze.",
        "SP": 10.0,
        "Elem": "Quantum",
        "DMG": [
            2
    ...
    "301402205": {
        "Key": "Skill05",
        "Name": "Losing Eventide Light",
        "Desc": "Immediately deals a killing blow to the character that acted last.",
        "SP": 0,
        "Threat": true
    },
    "301402206": {
    ...
    "301402207": {
        "Key": "Skill07",
        "Name": "Watery Dissolution",
        "Desc": "Immediately deals fatal damage to all locked-on targets. If no targets are being locked on, randomly lock on to two targets.",
        "SP": 0,
        "Threat": true
    },
    "301402208": {
