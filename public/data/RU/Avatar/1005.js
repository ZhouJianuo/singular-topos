...
var _avatarskill_ = {
    "100501": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Lightning DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Kafka's ATK to a single enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "100502": {
        "Pre": {
            ...
            "Type": "Skill",
            "Tag": "Blast",
            "Desc": "Deals Lightning DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Kafka's ATK to a target enemy and Lightning DMG equal to <color style='color:#f29e38;'><b>#3[p]</b></color> of Kafka's ATK to enemies adjacent to it.<br>If the target enemy is currently receiving DoT, all DoTs currently placed on that enemy immediately produce DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of their original DMG.",
            "Params": [
                [
                    0.8,
                    0.6,
    ...
    "100504": {
        "Pre": {
            ...
            "Type": "Talent",
            "Tag": "Single Target",
            "Desc": "After an ally of Kafka's uses Basic ATK on an enemy target, Kafka immediately launches 1 <u>follow-up attack</u> and deals Lightning DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of her ATK to that target, with a <b>#2[p]</b> <u>base chance</u> to inflict Shock equivalent to that applied by her Ultimate to the attacked enemy target, lasting for <b>#3[f]</b> turns. This effect can only be triggered 1 time per turn.",
            "Params": [
                [
                    0.42,
                    1.0,
...
var _avatarskilltree_ = {
    "1005": {
        "Pre": {
            ...
            "Tree2": {
                "Name": "Plunder",
                "Desc": "If an enemy is defeated while Shocked, Kafka additionally regenerates <b><color style='color:#f29e38'>5.0</color></b> Energy.",
                "Icon": "SkillIcon_1005_SkillTree2"
            },
            "Tree3": {
                "Name": "Thorns",
                "Desc": "The base chance for target enemies to get Shocked by the Ultimate, the Technique, or the Talent-triggered follow-up attack increases by <b><color style='color:#f29e38'>30.0%</color></b>.",
...
var _avatarrank_ = {
    "100501": {
        "Pre": {
            "Rank": 1,
            "Name": "Da Capo",
            "Desc": "When the Talent triggers a follow-up attack, there is a <b><color style='color:#f29e38'>100.0%</color></b> base chance to increase the DoT received by the target by <b><color style='color:#f29e38'>30.0%</color></b> for <b><color style='color:#f29e38'>2.0</color></b> turn(s).",
    ...
    "100502": {
        "Pre": {
            "Rank": 2,
            "Name": "Fortississimo",
            "Desc": "While Kafka is on the field, DoT dealt by all allies increases by <b><color style='color:#f29e38'>25.0%</color></b>.",
    ...
    "100504": {
        "Pre": {
            "Rank": 4,
            "Name": "Recitativo",
            "Desc": "When an enemy target takes DMG from the Shock status inflicted by Kafka, Kafka additionally regenerates <b><color style='color:#f29e38'>2.0</color></b> Energy.",
    ...
    "100506": {
        "Pre": {
            "Rank": 6,
            "Name": "Leggiero",
            "Desc": "The Shock inflicted on the enemy target by the Ultimate, the Technique, or the Talent-triggered follow-up attack has a DMG multiplier increase of <b><color style='color:#f29e38'>156.0%</color></b> and lasts <b><color style='color:#f29e38'>1.0</color></b> turn(s) longer.",
