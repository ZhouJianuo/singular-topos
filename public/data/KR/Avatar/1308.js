...
var _avatarskill_ = {
    "130801": {
        ...
        "v4": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Lightning DMG equal to <color style='color:#f29e38;'><b>104201.0%</b></color> of Acheron's ATK to a single target enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "130802": {
        ...
        "v4": {
            ...
            "Type": "Skill",
            "Tag": "Blast",
            "Desc": "Gains <b>1042.03</b> point(s) of Slashed Dream. Inflicts <b>1042.03</b> stack(s) of Crimson Knot on a single target enemy, dealing Lightning DMG equal to <color style='color:#f29e38;'><b>104201.0%</b></color> of Acheron's ATK to this target, as well as Lightning DMG equal to <color style='color:#f29e38;'><b>104202.0%</b></color> of Acheron's ATK to adjacent targets.",
            "Params": [
                [
                    0.8,
                    0.3,
    ...
    "130803": {
        ...
        "v2": {
            ...
            "Type": "Ultimate",
            "Tag": "AoE",
            "Desc": "Consecutively unleashes Rainblade 3 times and then Stygian Resurge 1 time, dealing at most <color style='color:#f29e38;'> <b>#6[p]</b> </color> Thunder DMG to a single target and at most <color style='color:#f29e38;'> <b>#7[p]</b> </color> Thunder DMG to all other targets.<br><br><b>Rainblade</b><br>Deal <color style='color:#f29e38;'> <b>#1[p]</b> </color> Thunder DMG to a single enemy, and removes up to 3 stacks of Crimson Knot from the target. When Crimson Knot is removed, deals <color style='color:#f29e38;'> <b>#2[p]</b> </color> Lightning DMG to all enemies 1 time, with the DMG multiplier for this attack additionally increased by <color style='color:#f29e38;'> <b>#2[p]</b> </color> for every stack of Crimson Knot removed, not exceeding <color style='color:#f29e38;'> <b>#5[p]</b> </color>.<br><br><b>Stygian Resurge</b><br>Deals <color style='color:#f29e38;'> <b>#3[p]</b> </color> Lightning DMG to all enemies, and removes all Crimson Knot stacks.<br><br>Crimson Knot is not inflicted upon enemies during the Ultimate.",
            "Params": [
                [
                    0.144,
                    0.09,
        ...
        "v4": {
            ...
            "Type": "Ultimate",
            "Tag": "AoE",
            "Desc": "Sequentially unleash Rainblade 3 times and Stygian Resurge 1 time, dealing Lightning DMG up to <color style='color:#f29e38;'><b>104206.0%</b></color> of Acheron's ATK to a single target enemy, as well as Lightning DMG up to <color style='color:#f29e38;'><b>104207.0%</b></color> of Acheron's ATK to other targets.<br><br>Rainblade: Deals Lightning DMG equal to <color style='color:#f29e38;'><b>104201.0%</b></color> of Acheron's ATK to a single target enemy and removes up to 3 stacks of Crimson Knot from the target. When Crimson Knot is removed, immediately deals Lightning DMG equal to <color style='color:#f29e38;'><b>104202.0%</b></color> of Acheron's ATK to all enemies. For every stack of Crimson Knot removed, the DMG Multiplier for this is additionally increased, up to a maximum of <color style='color:#f29e38;'><b>104205.0%</b></color>.<br><br>Stygian Resurge: Deals Lightning DMG equal to <color style='color:#f29e38;'><b>104203.0%</b></color> of Acheron's ATK to all enemies and remove all Crimson Knots.<br>Crimson Knot cannot be applied to enemies during the Ultimate.",
            "Params": [
                [
                    0.144,
                    0.09,
    ...
    "130807": {
        ...
        "v4": {
            ...
            "Type": "Technique",
            "Tag": "",
            "Desc": "Immediately attacks the enemy. At the start of each wave, gains Quadrivalent Ascendance, dealing Lightning DMG equal to <b>104201.0%</b> of Acheron's ATK to all enemies and reducing Toughness of all enemies irrespective of Weakness Types. When Weakness is broken, triggers the Lightning Weakness Break effect.<br>Quadrivalent Ascendance: After using the Ultimate, Acheron gains <b>1042.02</b> point(s) of Slashed Dream and inflicts <b>1042.02</b> stack(s) of Crimson Knot on a single random enemy.<br>If attacking a normal enemy, immediately defeats them without entering combat. When not hitting any enemies, no Technique Points are consumed.",
            "Params": [
                [
                    2.0,
                    1.0
...
var _avatarskilltree_ = {
    "1308": {
        "v0": {
            "Tree1": {
                "Name": "Trace 1",
                "Desc": "After entering battle, will gain some Energy Points."
            },
            "Tree2": {
                "Name": "Trace 2",
                "Desc": "For every Nihility Path character in the team, Acheron's DMG dealt is increased independently from other buffs. This counts a maximum of 2 Nihility Path characters, and does not count Acheron herself."
            },
            "Tree3": {
                "Name": "Trace 3",
                "Desc": "When triggering <color style='color:#f29e38'>Lotus Bloom</color>, for every Lotus consumed, Acheron's DMG dealt is increased for some turns."
            }
        },
        "v1": {
            "Add": {
            ...
            "Tree1": {
                "Name": "Red Ogre",
                "Desc": "At the start of battle, immediately gain <b><color style='color:#f29e38'>4.0</color></b> point(s) of Slashed Dream and apply <b><color style='color:#f29e38'>4.0</color></b> stack(s) of Crimson Knot to a random enemy.",
...
var _story_ = {
    "1308": [
        {
            "_id": 1,
            "Story": "「갤럭시 레인저」를 자칭하는 여행자. 본명은 알 수 없다. 긴 검 한 자루를 차고 홀로 은하를 항해하고 있다.<br><br>냉담하고 과묵하다. 그녀의 검은 뇌전처럼 빠르고 맹렬하지만 검집으로만 전투하고 검을 뽑지 않는다"
        },
        {
            "_id": 2,
            "Story": "<i>「…사람이 검을 선택한 것이 아니라, 검이 사람을 선택한 것이다. ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇. …그날, 내 손에서 탄생한 『검』이 다시 소녀에게 건네지는 모습을 보며 이런 생각이 들었다. ▇▇▇▇에 대항하는 길에서 그녀가 선택한 것은——어쩌면 선택 당한 것일지도 모르지만——그 ▇▇ 내일로 향하는 것 같은 길이었음을. ▇ 이것이 아름다운 시대이기를 ▇▇▇▇▇. 이즈모국은 여전히 위협을 받고 있지만, 사람들은 여전히 희망을 가지고, ▇▇이 전부 소탕되어 세상이 다시 자유를 얻게 될 것이라고 믿는다…. ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇……」</i><br><br><align=\"right\">——오래된 잔권</align>"
        },
        {
            "_id": 3,
            "Story": "<i>「…검을 만드는 자가 남긴 잔권에서 알 수 있듯이, 이즈모는 한때 멸망의 위기에 처한 적이 있다. 존속을 위해 그들은 ▇▇▇▇로 검을 만들었고, 이 검을 지닌 자를 구국의 영웅으로 여겼다.<br><br>아쉽게도 이 세계가 이미 성도(星圖)에서 사라졌기에, 역사의 진실을 더이상 찾을 수 없고, 『기억』도 더는 존재하지 않는다. 무장 고고학파가 도착했을 때 은하계에는 「신비」한 노랫자락만 울려 퍼질 뿐이었다. 끝없는 비가 ▇▇에서 눈물처럼 솟아 나오고, 희미한 비의 장막 속에서 이즈모국의 후손은 ▇▇▇▇▇▇ 지워버린 고향을 등졌다……」</i><br><br><align=\"right\">——「집필자」 오펜하이머</align>"
        },
        {
            "_id": 4,
            "Story": "<i>「깊은 잠에 빠지게 만드는 『각성-310』 제제를 사용하여 과거 기억을 되살렸다. 일부 환자들은 이것으로 ██████을 되찾았지만, 그녀는 달랐다. 그녀 이전에 깊은 잠에서 혼자 깨어난 사람은 없었다. 그녀의 꿈을 관찰해 보았는데… 그것은 행복이라고 부르기 매우 어려운 기억이었다. 음침한 하늘, 부서진 도시, 폐허들, 그리고 비가 끝없이 내리고 있었다.<br><br>영원히 멈추지 않을 것처럼 내리는 비와 불어나는 물속에서 사람들은 죽어가면서도 미소를 지었다. 그 타락의 밤에 머나먼 곳에서 천둥소리가 들렸다. 그러다 한 순간에 번개가 번쩍이며 검은 밤을 갈랐다. 부서진 하늘 아래에서 나는 다시 그녀를 보았다——모든 것이 퇴색되어 사라져 가는 세계에서, 그녀는 가볍게 검을 휘둘러 모든 꿈세계를 데리고 갔다.<br><br>이 길에서 그녀가 우리보다 한참 멀리 갔다는 것을 인정해야만 한다. 종잡을 수 없는 ████가 그녀를 ██로 이끌었지만, 그녀는 저도 모르게 그것을 손에 쥐고 있었다. 어쩌면 여정의 처음부터 그녀는 진정한 적과 맞설 준비를 마쳤는지도 모른다……」</i><br><br><align=\"right\">——어느 약제사의 노트</align>"
        },
        {
            "_id": 5,
            "Story": "<i>「이 편지를 여기에 남긴다. 내가 만약 돌아오지 못한다면, 이것으로 그녀의 이야기를 전하겠다. 그녀는 내가 ████에서 만났던 동료이다. 저편으로 향하는 길은 더없이 험난했지만, 다행히 그녀와 동행하였기에 평안할 수 있었다……<br><br>…우리가 만나기 전, 그녀는 이미 많은 세계를 경험했고, 다양한 생활 스킬에 능숙했다. 나는 그녀와 함께 야외에서 요리하고 텐트를 쳤다. 별이 없는 밤이면 그녀는 내 이야기를 들어주고, 다음날 할 일을 의논하기도 했다. 대개 우리는 묵묵히 길을 걸을 뿐이었다. 이곳의 눈은 자홍색이었고, 맛을 보면 산딸기처럼 새콤달콤했다. 그녀는 ████, 내가 만든 ████ 눈 경단을 칭찬해주었다……<br><br>…그녀를 알기 전 나는 오랜 세월 동안 ██ 강을 두루 걸었다. 그녀는 내게 손을 내밀어주었고, 우리는 이 강을 따라 함께 걸었다. 이제 헤어져야 할 때가 왔지만, 나는 강가에 도착하지도 못했고, 무엇을 마주하게 될지도 모른다…. 하지만 내게는 발걸음을 멈출 이유가 없다. 인생이란 언젠가는 끝이 나는 길이니, 그 전에 나는 내 두 발로 끝에 도달할 것이다. 그녀도 그럴 것이라 믿는다」</i><br><br><align=\"right\">——어느 탐험가의 노트</align>"
        },
        {
            "_id": 6,
            "Story": "<i>「…사람이 검을 선택한 것이 아니라, 검이 사람을 선택한 것이다. <color=#ff3a3e>사람이 운명을 선택하는 것이 아니라, 운명이 사람을 선택하는 것처럼</color>…. 그날, 내 손에서 탄생한 『검』이 다시 소녀에게 건네지는 모습을 보며 이런 생각이 들었다.<color=#ff3a3e>『팔백만 신』</color>에 대항하는 길에서 그녀가 선택한 것은——어쩌면 선택 당한 것일지도 모르지만——그 <color=#ff3a3e>마치</color> 내일로 향하는 것 같은 길이었음을. 난 이것이 아름다운 시대이기를 <color=#ff3a3e>진정으로 바랐다</color>. 이즈모국은 여전히 위협을 받고 있지만, 사람들은 여전히 희망을 가지고, <color=#ff3a3e>악신</color>이 전부 소탕되어 세상이 다시 자유를 얻게 될 것이라고 믿는다….<color=#ff3a3e>하지만 검광이 사라지고 나서야 깨달았다. 이건 끝이 없는 죽음의 길이라는 사실을. 이 길에 발을 들인 사람들은 다시 돌아갈 수 없다는 것을</color>……」</i><br><br><align=\"right\">——오래된 잔권</align>"
        },
        {
            "_id": 7,
            "Story": "<i>「…검을 만드는 자가 남긴 잔권에서 알 수 있듯이, 이즈모는 한때 멸망의 위기에 처한 적이 있다. 존속을 위해 그들은 <color=#ff3a3e>『신의 유해』</color>로 검을 만들었고, 이 검을 지닌 자를 구국의 영웅으로 여겼다. <color=#ff3a3e>학회는 그중 『팔백만 신』에 대해 관심을 가지고 있지만, 이들이 어떤 운명의 길과 연관돼 있는지 아직 모른다. 이후의 기록에 따르면, 이즈모국 사람들이 검의 주인을 부르는 호칭이 『인간』에서 『{RUBY_B#오니}귀(鬼){RUBY_E#}』로 점차 바뀌었다고 한다.</color><br><br>아쉽게도 이 세계가 이미 성도(星圖)에서 사라졌기에, 역사의 진실을 더이상 찾을 수 없고, 『기억』도 더는 존재하지 않는다. 무장 고고학파가 도착했을 때 은하계에는 「신비」한 노랫자락만 울려 퍼질 뿐이었다. 끝없는 비가 <color=#ff3a3e>검은 태양</color>에서 눈물처럼 솟아 나오고, 희미한 비의 장막 속에서 이즈모국의 후손은 <color=#ff3a3e>그녀의 손에 구원받고 또 그녀가 직접</color> 지워버린 고향을 등졌다….<color=#ff3a3e>그녀 앞은 보이지 않는 그림자뿐이었다</color>」</i><br><br><align=\"right\">——「집필자」 오펜하이머</align>"
        },
        {
            "_id": 8,
            "Story": "<i>「깊은 잠에 빠지게 만드는 『각성-310』 제제를 사용하여 과거 기억을 되살렸다. 일부 환자들은 이것으로 <color=#ff3a3e>삶에 대한 자신감</color>을 되찾았지만, 그녀는 달랐다. 그녀 이전에 깊은 잠에서 혼자 깨어난 사람은 없었다. 그녀의 꿈을 관찰해 보았는데… 그것은 행복이라고 부르기 매우 어려운 기억이었다. 음침한 하늘, 부서진 도시, 폐허들, 그리고 비가 끝없이 내리고 있었다.<br><br>영원히 멈추지 않을 것처럼 내리는 비와 불어나는 물속에서 사람들은 죽어가면서도 미소를 지었다. 그 타락의 밤에 머나먼 곳에서 천둥소리가 들렸다. 그러다 한 순간에 번개가 번쩍이며 검은 밤을 갈랐다. 부서진 하늘 아래에서 나는 다시 그녀를 보았다——모든 것이 퇴색되어 사라져 가는 세계에서, 그녀는 가볍게 검을 휘둘러 모든 꿈세계를 데리고 갔다.<br><br>이 길에서 그녀가 우리보다 한참 멀리 갔다는 것을 인정해야만 한다. 종잡을 수 없는 <color=#ff3a3e>『공허』</color>가 그녀를 <color=#ff3a3e>자멸</color>로 이끌었지만, 그녀는 저도 모르게 그것을 손에 쥐고 있었다. 어쩌면 여정의 처음부터 그녀는 진정한 적과 맞설 준비를 마쳤는지도 모른다…… <color=#ff3a3e>나는 그녀에게 이 모든 게 무슨 의미인지 물은 적이 있으나, 그녀는 대답하지 않았다. 뭐라고 대답해야 할지 몰랐던 것일까? 아니면 마음속에 정해둔 답이 이미 있었던 것일까?</color>」</i><br><br><align=\"right\">——어느 <color=#ff3a3e>혼돈의 의사</color>의 노트</align>"
        },
        {
            "_id": 9,
            "Story": "<i>「이 편지를 여기에 남긴다. 내가 만약 돌아오지 못한다면, 이것으로 그녀의 이야기를 전하겠다. 그녀는 내가 <color=#ff3a3e>오크론</color>에서 만났던 동료이다. 저편으로 향하는 길은 더없이 험난했지만, 다행히 그녀와 동행하였기에 평안할 수 있었다. <color=#ff3a3e>처음 만났을 때, 그녀가 어떤 사명을 짊어지고 있는 것 같다고 생각했다. 그게 「복수」일까? 아닐 것이다. 마음속에 원한을 품은 사람은 언젠가는 그걸 드러내기 마련이다. 하지만 그녀는 언제나 차분했고, 가끔 슬픔을 내비쳤다……</color><br><br>…우리가 만나기 전, 그녀는 이미 많은 세계를 경험했고, 다양한 생활 스킬에 능숙했다. 나는 그녀와 함께 야외에서 요리하고 텐트를 쳤다. 별이 없는 밤이면 그녀는 내 이야기를 들어주고, 다음날 할 일을 의논하기도 했다. 대개 우리는 묵묵히 길을 걸을 뿐이었다. 이곳의 눈은 자홍색이었고, 맛을 보면 산딸기처럼 새콤달콤했다. 그녀는 <color=#ff3a3e>미각을 거의 잃었지만, 여전히</color> 내가 만든 오크론 눈 경단을 칭찬해주었다……<br><br>…그녀를 알기 전 나는 오랜 세월 동안<color=#ff3a3e>『공허』의</color> 강을 두루 걸었다. 그녀는 내게 손을 내밀어주었고, 우리는 이 강을 따라 함께 걸었다. 이제 헤어져야 할 때가 왔지만, 나는 강가에 도착하지도 못했고, 무엇을 마주하게 될지도 모른다…. 하지만 내게는 발걸음을 멈출 이유가 없다. 인생이란 언젠가는 끝이 나는 길이니, 그 전에 나는 내 두 발로 끝에 도달할 것이다. 그녀도 그럴 것이라 믿는다」</i><br><br><align=\"right\">——<color=#ff3a3e>「플레바스」</color>의 노트</align>"
        }
    ]
}
...
var _voice_ = {
    "1308": [
        {
            "Title": "첫 만남",
            "Voice": "「아케론」… 빌려온 이름일 뿐이지만, 넌 내가 어떤 사람인지 알고, 나의 행적도 기억하지…. 그렇다면… 난 아케론이야"
        },
        {
            "Title": "인사",
            "Voice": "비가 오네…. {NICKNAME}, 같이 좀 걸을까? 가자, 나한테 우산이 있어"
        },
        {
            "Title": "작별",
            "Voice": "이제 출발해야겠어. 이 세상은 비처럼 사라지고 결국 대지로 돌아가지. 다음에 만날 땐… 맑은 날이면 좋겠군"
        },
        {
            "Title": "자신에 대해•행동",
            "Voice": "홀로 은하를 항해하는 자가 갈망하는 건 딱 두 가지야. 과거 선배들의 행적을 찾고, 자기만의 길을 모색하는 거지. 하지만 {RUBY_B#에이언즈}그들{RUBY_E#}의 눈길 속에서… 대부분은 첫 번째에서 멈추기 마련이야"
        },
        {
            "Title": "자신에 대해•습관",
            "Voice": "어렴풋이 기억나는데, 고향에는 종종 뇌우가 내리곤 했어. 여자아이들은 화장이 번질까 봐 항상 화장 도구를 갖고 다녔지. 그때와 이유는 다르지만… 난 여전히 그 습관을 유지하고 있어"
        },
        {
            "Title": "자신에 대해•신분",
            "Voice": "꿈은 본래 아무런 의미가 없지만, 거기에 의미를 부여하는 건 삶의 색채야. 「공허함」 가득한 색채뿐이라면, 꿈도 흑백의 빈 껍데기만 남겠지"
        },
        {
            "Title": "잡담•비",
            "Voice": "빗방울이 빨간 잎사귀에서 우산 위로 똑똑 떨어지는 소리를 듣고 있으면… 잠시 평온을 얻을 수 있어"
        },
        {
            "Title": "잡담•검",
            "Voice": "검을 지니고 있으면 그걸로 뭔가를 베어야 해. 내가 검을 뽑는 이유는… 예전에도, 지금도, 앞으로도 하나뿐이야"
        },
        {
            "Title": "취미•복숭아",
            "Voice": "복숭아엔 삶의 기쁨과 달콤함이 담겨 있지만, 또 그만큼 연약하고 쉽게 부서지기 마련이야…. 이런 아쉬움은 어쩔 수 없는 것이니 그냥 내버려 둬야겠지"
        },
        {
            "Title": "고민",
            "Voice": "그곳에서 깨어났을 때, 바다의 끝에선 여전히 우렛소리가 희미하게 들렸고, 하늘에서는 마침 혈우가 흩날렸지——그 순간의 광경은 그 무엇보다 선명하게 머릿속에 남았어"
        },
        {
            "Title": "고민",
            "Voice": "피안에서 깨어났을 때, 바다의 끝에선 여전히 우렛소리가 희미하게 들렸고, 하늘에서는 마침 혈우가 흩날렸지——그 순간의 광경은 그 무엇보다 선명하게 머릿속에 남았어. 그리고 그 전후의 기억은 빛을 잃고 점차 퇴색됐지"
        },
        {
            "Title": "공유•무기",
            "Voice": "이 검이 궁금해? 검을 뽑을 때면, 안에 봉인돼 있던, 내가 이 검을 휘두르던 기억이 하나씩 떠올라. 「{RUBY_B#하지메}처음(始){RUBY_E#}」에서부터 「{RUBY_B#오와리}끝(終){RUBY_E#}」을 거쳐… 「무(無)」에 이르기까지 전부"
        },
        {
            "Title": "견문•블랙홀",
            "Voice": "블랙홀은 장엄하지도 처참하지도 않아. 고독한 시선처럼 고요하게 우리를 지켜보고 있다가… 조용히 모든 것을 집어삼키고, 모든 것을 말없이 차갑게 포옹하지"
        },
        {
            "Title": "견문•운명의 길",
            "Voice": "탐구와 깨달음, 존재를 위해… 인간은 운명의 길을 걷는 거야"
        },
        {
            "Title": "견문•운명의 길",
            "Voice": "인간은 운명의 길을 걷고 난 후에… 비로소 탐구하고, 깨닫고, 존재하지"
        },
        {
            "Title": "{NICKNAME}에 대해",
            "Voice": "나도 한때 너처럼 누군가의 마음에 남았던 적이 있어. 돌이켜보면 사소한 순간들이 수천 마디 말보다 더 가치 있었던 것 같아…. 과거가 지금의 우리를 만들었고, 떠오르지 않는 일들이 있는가 하면, 잊기 어려운 일들도 있지"
        },
        {
            "Title": "반디에 대해",
            "Voice": "반디를 보고 있으면 꼭 숲속의 반딧불이 눈 앞에 펼쳐지는 것 같아. 눈부시고 황홀하지만 그 빛은 찰나에 사라지고 말지"
        },
        {
            "Title": "블랙 스완에 대해",
            "Voice": "우아하고 단정한 여인이지. 난 그녀의 호의적인 초청을 기억할 거야. 그 춤은… 따뜻하고 그리운 느낌이었어"
        },
        {
            "Title": "어벤츄린에 대해",
            "Voice": "욕망으로 위장한 조각난 공허함… 그의 존재는 매우 강렬하지만, 그 아래 숨겨진 자아는 너무나도 얄팍해"
        },
        {
            "Title": "웰트에 대해",
            "Voice": "「영웅」이라고 불릴 수 있는 사람은 아주 다양한데, 그는 그중에서 가장 순수한 부류야…. 난 그런 부류의 사람들과 많이 만나고 이별했지"
        },
        {
            "Title": "샘에 대해",
            "Voice": "불타는 거인이 가는 곳은 모두 잿더미가 돼. 하지만 화염이 사그라진 후 고개를 떨구고 고독한 두 손으로 재를 받쳐 드는 것 역시… 그 끝없는 불길에 휩싸인 자들이지"
        },
        {
            "Title": "성혼 활성화",
            "Voice": "「같은 강물에 발을 두 번 담그는 건」… 어려운 일이 아냐"
        },
        {
            "Title": "캐릭터 승급",
            "Voice": "절대 뒤돌아보지 마. 왔던 길론 돌아갈 수 없으니"
        },
        {
            "Title": "캐릭터 최고 레벨",
            "Voice": "멀리 있는 풍경은 잘 보이지 않지만… 분명 아름다움을 간직하고 있을 거야"
        },
        {
            "Title": "행적 활성화",
            "Voice": "또 비가 내리네. 또 텅 비었어"
        },
        {
            "Title": "파티 편성•{NICKNAME}",
            "Voice": "너구나… 서로가 존재하는 시간을 소중히 여기자"
        },
        {
            "Title": "파티 편성•블랙 스완",
            "Voice": "또 만났네. 한 곡 더 추지 않을래, 기억하는 자?"
        },
        {
            "Title": "파티 편성•어벤츄린",
            "Voice": "모든 걸 얻을지, 아니면 모든 걸 잃을지는… 시간이 말해주겠지"
        },
        {
            "Title": "파티 편성•웰트",
            "Voice": "눈앞에 블랙홀이 있어도… 우리에겐 선택권이 있어"
        },
        {
            "Title": "전투 시작•약점 격파",
            "Voice": "좋아, 발버둥 칠 수고를 덜었군"
        },
        {
            "Title": "전투 시작•위험 경보",
            "Voice": "상관없어. 여기서 끝내주지"
        ...
        {
            "Title": "턴 시작•1",
            "Voice": "이곳에 온 건 너의 의지일까… 운명의 길의 의지일까?"
        },
        {
            "Title": "턴 시작•2",
            "Voice": "출발할 시간이야"
        ...
        {
            "Title": "전투 스킬•1",
            "Voice": "이번 생은 아침 이슬처럼, 몸도 이름도 사라지리"
        },
        {
            "Title": "전투 스킬•2",
            "Voice": "망각의 강엔 파도가 없고, 떠도는 자를 인도하지"
        },
        {
            "Title": "약공격 피격",
            "Voice": "또야?"
        ...
        {
            "Title": "필살기•활성화",
            "Voice": "죽은 자를 위해 눈물을 흘리리……"
        },
        {
            "Title": "필살기•발동",
            "Voice": "황혼의 비가, 결국엔 내릴 거야"
        },
        {
            "Title": "전투 불능",
            "Voice": "먼지는… 결국 대지로 돌아가게 돼 있어……"
        },
        {
            "Title": "전투 복귀",
            "Voice": "조금 더 같이 있어 줄게"
        ...
        {
            "Title": "전리품 오픈•1",
            "Voice": "구하면 반드시 얻게 될 거야"
        },
        {
            "Title": "전리품 오픈•2",
            "Voice": "동료들과 이 기쁨을 나누는 걸 잊지 마"
        },
        {
            "Title": "진귀한 전리품 오픈",
            "Voice": "봐, 이것도 은하를 여행하는 의미지"
        },
        {
            "Title": "수수께끼 풀이 성공•1",
            "Voice": "생명 자체가… 하나의 수수께끼지"
        },
        {
            "Title": "수수께끼 풀이 성공•2",
            "Voice": "어쩌면, 정답은 하나가 아닐지도 몰라"
        },
        {
            "Title": "적 발견",
            "Voice": "곧 폭풍우가 몰아칠 거야"
        ...
        {
            "Title": "도시로 복귀",
            "Voice": "추억이 남은 곳을 만져보니 전부 가시 달린 꽃뿐이네……"
        }
    ]
}