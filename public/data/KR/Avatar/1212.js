...
var _avatarskill_ = {
    "121201": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Ice DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Jingliu's ATK to a single enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "121202": {
        "Pre": {
            ...
            "Type": "Skill",
            "Tag": "Single Target",
            "Desc": "Deals Ice DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Jingliu's ATK to a single enemy and obtains <b>#2[f]</b> stack(s) of Syzygy.",
            "Params": [
                [
                    1.0,
                    1.0
    ...
    "121203": {
        "Pre": {
            ...
            "Type": "Ultimate",
            "Tag": "Blast",
            "Desc": "Deals Ice DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Jingliu's ATK to a single enemy, and deals Ice DMG equal to <color style='color:#f29e38;'><b>#3[p]</b></color> of Jingliu's ATK to any adjacent enemies. Gains <b>#2[f]</b> stack(s) of Syzygy after attack ends.<br>Hidden Stat: #4[f]",
            "Params": [
                [
                    1.8,
                    1.0,
    ...
    "121204": {
        "Pre": {
            ...
            "Type": "Talent",
            "Tag": "Enhance",
            "Desc": "When Jingliu has <b>#5[f]</b> stack(s) of Syzygy, she enters the Spectral Transmigration state with her Action Advanced by <b>#6[p]</b> and her CRIT Rate increases by <color style='color:#f29e38;'><b>#7[p]</b></color>. Then, Jingliu's Skill \"Transcendent Flash\" is enhanced to \"Moon On Glacial River,\" and only this enhanced Skill is available for use in battle. When Jingliu uses an attack in the Spectral Transmigration state, she consumes HP from all other allies equal to <b>#2[p]</b> of their respective Max HP (this cannot reduce allies' HP to lower than 1). Jingliu's ATK increases by <b>#3[p]</b> of the total HP consumed from all allies in this attack, capped at <color style='color:#f29e38;'><b>#4[p]</b></color> of her base ATK, lasting until the current attack ends. Jingliu cannot enter the Spectral Transmigration state again until the current Spectral Transmigration state ends. Syzygy can stack up to 3 times. When Syzygy stacks become 0, Jingliu will exit the Spectral Transmigration state.<br>Hidden Stat: #1[f]",
            "Params": [
                [
                    0.3,
                    0.04,
    ...
    "121207": {
        "Pre": {
            ...
            "Type": "Technique",
            "Tag": "Impair",
            "Desc": "After using this Technique, creates a dimension around Jingliu that lasts for <b>#3[f]</b> seconds, and all enemies in this dimension will become Frozen. After entering combat with enemies in the dimension, Jingliu immediately regenerates <b>#6[f]</b> Energy and obtains <b>#1[f]</b> stack(s) of Syzygy, with a <b>#2[p]</b> <u>base chance</u> of Freezing enemy targets for <b>#4[f]</b> turn(s). While Frozen, enemy targets cannot take action, and receive Ice <u>Additional DMG</u> equal to <b>#5[p]</b> of Jingliu's ATK at the start of every turn. Only 1 dimension created by allies can exist at the same time.",
            "Params": [
                [
                    1.0,
                    1.0,
    ...
    "121209": {
        "Pre": {
            ...
            "Type": "Skill",
            "Tag": "Blast",
            "Desc": "Deals Ice DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Jingliu's ATK to a single enemy, and deals Ice DMG equal to <color style='color:#f29e38;'><b>#3[p]</b></color> of Jingliu's ATK to adjacent enemies. Consumes <b>#2[f]</b> stack(s) of Syzygy. Using this ability does not consume Skill Points.",
            "Params": [
                [
                    1.25,
                    1.0,
...
var _avatarskilltree_ = {
    "1212": {
        "Pre": {
            ...
            "Tree1": {
                "Name": "Deathrealm",
                "Desc": "While in the Spectral Transmigration state, increases Effect RES by <b><color style='color:#f29e38'>35.0%</color></b>.",
                "Icon": "SkillIcon_1212_SkillTree1"
            },
            "Tree2": {
                "Name": "Sword Champion",
                "Desc": "After using Transcendent Flash, the next action will be Advanced Forward by <b><color style='color:#f29e38'>10.0%</color></b>.",
                "Icon": "SkillIcon_1212_SkillTree2"
            },
            "Tree3": {
                "Name": "Frost Wraith",
                "Desc": "While in the Spectral Transmigration state, increases Ultimate DMG by <b><color style='color:#f29e38'>20.0%</color></b>.",
...
var _avatarrank_ = {
    "121201": {
        "Pre": {
            ...
            "Desc": "When using her Ultimate or Enhanced Skill, Jingliu's CRIT DMG increases by <b><color style='color:#f29e38'>24.0%</color></b> for <b><color style='color:#f29e38'>1.0</color></b> turn(s). If only one enemy target is attacked, the target will additionally be dealt Ice DMG equal to <b><color style='color:#f29e38'>100.0%</color></b> of Jingliu's ATK.",
    ...
    "121202": {
        "Pre": {
            ...
            "Desc": "After using Ultimate, increases the DMG of the next Enhanced Skill by <b><color style='color:#f29e38'>80.0%</color></b>.",
    ...
    "121204": {
        "Pre": {
            ...
            "Desc": "During the Spectral Transmigration state, the ATK gained from consuming allies' HP is additionally increased by <b><color style='color:#f29e38'>90.0%</color></b> of the total HP consumed from the entire team. The cap for ATK gained this way also increases by <b><color style='color:#f29e38'>30.0%</color></b>.",
    ...
    "121206": {
        "Pre": {
            ...
            "Desc": "When Jingliu enters the Spectral Transmigration state, the Syzygy stack limit increases by 1, and Jingliu obtains <b><color style='color:#f29e38'>1.0</color></b> stack(s) of Syzygy. While she is in the Spectral Transmigration state, her CRIT DMG increases by <b><color style='color:#f29e38'>50.0%</color></b>.",
