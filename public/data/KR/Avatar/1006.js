...
var _avatarskill_ = {
    "100601": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Quantum DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Silver Wolf's ATK to a single enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "100603": {
        "Pre": {
            ...
            "Type": "Ultimate",
            "Tag": "Single Target",
            "Desc": "There's a <color style='color:#f29e38;'><b>#2[p]</b></color> <u>base chance</u> to decrease the target enemy's DEF by <color style='color:#f29e38;'><b>#3[p]</b></color> for <b>#4[f]</b> turn(s). And at the same time, deals Quantum DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Silver Wolf's ATK to the target enemy.",
            "Params": [
                [
                    2.28,
                    0.85,
    ...
    "100604": {
        "Pre": {
            ...
            "Type": "Talent",
            "Tag": "Impair",
            "Desc": "Silver Wolf can create three types of Bugs: reduce ATK by <color style='color:#f29e38;'><b>#1[p]</b></color>, reduce DEF by <color style='color:#f29e38;'><b>#2[p]</b></color>, and reduce SPD by <color style='color:#f29e38;'><b>#3[p]</b></color>.<br>Every time Silver Wolf attacks, she has a <color style='color:#f29e38;'><b>#4[p]</b></color> <u>base chance</u> to implant a random Bug that lasts for <b>#5[f]</b> turn(s) in an enemy target.",
            "Params": [
                [
                    0.05,
                    0.04,
    ...
    "100607": {
        "Pre": {
            ...
            "Type": "Technique",
            "Tag": "",
            "Desc": "Immediately attacks the enemy. After entering battle, deals Quantum DMG equal to <b>#1[p]</b> of Silver Wolf's ATK to all enemies, and ignores Weakness Types and reduces Toughness from all enemies. Enemies with their Weakness Broken in this way will trigger the Quantum Weakness Break effect.",
            "Params": [
                [
                    0.8
                ]
...
var _avatarskilltree_ = {
    "1006": {
        "Pre": {
            ...
            "Tree1": {
                "Name": "Generate",
                "Desc": "Bug's duration is extended for <b><color style='color:#f29e38'>1.0</color></b> turn(s). Every time an enemy is inflicted with Weakness Break, Silver Wolf has a <b><color style='color:#f29e38'>65.0%</color></b> base chance of implanting a random Bug in the enemy.",
                "Icon": "SkillIcon_1006_SkillTree1"
            },
            "Tree2": {
                "Name": "Inject",
                "Desc": "The duration of the Weakness implanted by Silver Wolf's Skill increases by <b><color style='color:#f29e38'>1.0</color></b> turn(s).",
                "Icon": "SkillIcon_1006_SkillTree2"
            },
            "Tree3": {
                "Name": "Side Note",
                "Desc": "If there are <b><color style='color:#f29e38'>3.0</color></b> or more debuff(s) affecting the enemy when the Skill is used, then the Skill decreases the enemy's All-Type RES by an additional <b><color style='color:#f29e38'>3.0%</color></b>.",
...
var _avatarrank_ = {
    "100601": {
        "Pre": {
            ...
            "Desc": "After using her Ultimate to attack enemies, Silver Wolf regenerates <b><color style='color:#f29e38'>7.0</color></b> Energy for every debuff that the target enemy currently has. This effect can be triggered up to <b><color style='color:#f29e38'>5.0</color></b> time(s) in each use of her Ultimate.",
    ...
    "100602": {
        "Pre": {
            "Rank": 2,
            "Name": "Zombie Network",
            "Desc": "When an enemy enters battle, reduces their Effect RES by <b><color style='color:#f29e38'>20.0%</color></b>.",
    ...
    "100604": {
        "Pre": {
            "Rank": 4,
            "Name": "Bounce Attack",
            "Desc": "After using her Ultimate to attack enemies, deals Additional Quantum DMG equal to <b><color style='color:#f29e38'>20.0%</color></b> of Silver Wolf's ATK for every debuff currently on the enemy target. This effect can be triggered for a maximum of <b><color style='color:#f29e38'>5.0</color></b> time(s) during each use of her Ultimate.",
    ...
    "100606": {
        "Pre": {
            ...
            "Desc": "For every debuff the target enemy has, the DMG dealt by Silver Wolf increases by <b><color style='color:#f29e38'>20.0%</color></b>, up to a limit of <b><color style='color:#f29e38'>100.0%</color></b>.",
