...
var _avatarskill_ = {
    "121301": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Uses a 2-hit attack and deals Imaginary DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Dan Heng • Imbibitor Lunae's ATK to a single enemy target.",
            "Params": [
                [
                    0.5
                ],
    ...
    "121304": {
        "Pre": {
            ...
            "Type": "Talent",
            "Tag": "Enhance",
            "Desc": "After each hit dealt during an attack, Dan Heng • Imbibitor Lunae gains 1 stack of Righteous Heart, increasing his DMG by <color style='color:#f29e38;'><b>#1[p]</b></color>. This effect can stack up to <b>#2[f]</b> time(s), lasting until the end of his turn.",
            "Params": [
                [
                    0.05,
                    6.0
    ...
    "121307": {
        "Pre": {
            ...
            "Type": "Technique",
            "Tag": "Enhance",
            "Desc": "After using his Technique, Dan Heng • Imbibitor Lunae enters the Leaping Dragon state for <b>#2[f]</b> seconds. While in the Leaping Dragon state, using his attack enables him to move forward rapidly for a set distance, attacking all enemies he touches and blocking all incoming attacks. After entering combat via attacking enemies in the Leaping Dragon state, Dan Heng • Imbibitor Lunae deals Imaginary DMG equal to <b>#3[p]</b> of his ATK to all enemies, and gains <b>#1[f]</b> Squama Sacrosancta.",
            "Params": [
                [
                    1.0,
                    20.0,
    ...
    "121308": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Uses a 3-hit attack and deals Imaginary DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Dan Heng • Imbibitor Lunae's ATK to a single enemy target.",
            "Params": [
                [
                    1.3
                ],
    ...
    "121310": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Blast",
            "Desc": "Uses a 5-hit attack and deals Imaginary DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Dan Heng • Imbibitor Lunae's ATK to a single enemy target. From the fourth hit onward, simultaneously deals Imaginary DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Dan Heng • Imbibitor Lunae's ATK to adjacent targets.",
            "Params": [
                [
                    1.9,
                    0.3
    ...
    "121312": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Blast",
            "Desc": "Uses a 7-hit attack and deals Imaginary DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Dan Heng • Imbibitor Lunae's ATK to a single enemy target. From the fourth hit onward, simultaneously deal Imaginary DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Dan Heng • Imbibitor Lunae's ATK to adjacent targets.",
            "Params": [
                [
                    2.5,
                    0.9
...
var _avatarskilltree_ = {
    "1213": {
        "Pre": {
            ...
            "Tree2": {
                "Name": "Aqua Reign",
                "Desc": "Increases the chance to resist Crowd Control debuffs by <b><color style='color:#f29e38'>35.0%</color></b>.",
                "Icon": "SkillIcon_1213_SkillTree2"
            },
            "Tree3": {
                "Name": "Jolt Anew",
                "Desc": "When dealing DMG to enemy targets with Imaginary Weakness, CRIT DMG increases by <b><color style='color:#f29e38'>24.0%</color></b>.",
...
var _avatarrank_ = {
    "121301": {
        "Pre": {
            ...
            "Desc": "Increases the stackable Righteous Heart count by <b><color style='color:#f29e38'>4.0</color></b>, and gains 1 extra stack of Righteous Heart for each hit during an attack.",
    ...
    "121302": {
        "Pre": {
            ...
            "Desc": "After using his Ultimate, Dan Heng • Imbibitor Lunae's action is Advanced Forward by <b><color style='color:#f29e38'>100%</color></b> and gains 1 extra Squama Sacrosancta.",
    ...
    "121306": {
        "Pre": {
            "Rank": 6,
            "Name": "Reign, Returned",
            "Desc": "After any other ally uses their Ultimate, the Imaginary RES PEN of Dan Heng • Imbibitor Lunae's next Fulgurant Leap attack increases by <b><color style='color:#f29e38'>20.0%</color></b>. This effect can stack up to <b><color style='color:#f29e38'>3.0</color></b> time(s).",
