...
var _avatarskill_ = {
    "800601": {
        "v1": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Imaginary DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of the Trailblazer's ATK to a single enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "800602": {
        "v1": {
            ...
            "Type": "Skill",
            "Tag": "Bounce",
            "Desc": "Deals Imaginary DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Trailblazer's ATK to a single enemy and deals DMG for 4 extra times, dealing Imaginary DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Trailblazer's ATK to a random enemy each time.<br>Hidden Stat: #2[f]",
            "Params": [
                [
                    0.25,
                    2.0
    ...
    "800603": {
        "v1": {
            ...
            "Type": "Ultimate",
            "Tag": "Support",
            "Desc": "Applies the Backup Dancer effect to all allies, lasting for <b>#1[f]</b> turn(s). Decreases its duration by 1 turn at the start of Trailblazer's every turn. When allied targets with Backup Dancer attack an enemy in the <u>Weakness Broken state</u>, they will deal <u>Break DMG</u> 1 additional time based on <color style='color:#f29e38;'><b>#2[p]</b></color> of the attacker's Break DMG and the current attack's Toughness-Reducing DMG.<br><br><color style='color:#f29e38;'><b>Weakness Break State</b></color><br>When enemy targets' Toughness is reduced to 0, they will enter the Weakness Break State, which delays their actions.<br><br><color style='color:#f29e38;'><b>Break DMG</b></color><br>Damage type that is not affected by any stat aside from Break Effect. The higher the character level and the target's max Toughness, the higher the Break DMG.",
            "Params": [
                [
                    3.0,
                    0.6
    ...
    "800604": {
        "v1": {
            ...
            "Type": "Talent",
            "Tag": "Impair",
            "Desc": "The Trailblazer immediately regenerates <color style='color:#f29e38;'><b>#1[f]</b></color> Energy when an enemy target's Weakness is Broken.",
            "Params": [
                [
                    5.0
                ],
