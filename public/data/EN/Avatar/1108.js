...
var _avatarskill_ = {
    "110801": {
        "Pre": {
            ...
            "Type": "Basic ATK",
            "Tag": "Single Target",
            "Desc": "Deals Wind DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Sampo's ATK to a single enemy.",
            "Params": [
                [
                    0.5
                ],
    ...
    "110802": {
        "Pre": {
            ...
            "Type": "Skill",
            "Tag": "Bounce",
            "Desc": "Deals Wind DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Sampo's ATK to a single enemy, and further deals DMG for <b>#1[f]</b> extra time(s), with each time dealing Wind DMG equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Sampo's ATK to a random enemy.",
            "Params": [
                [
                    4.0,
                    0.28
    ...
    "110803": {
        "Pre": {
            ...
            "Type": "Ultimate",
            "Tag": "AoE",
            "Desc": "Deals Wind DMG equal to <color style='color:#f29e38;'><b>#1[p]</b></color> of Sampo's ATK to all enemies, with a <b>#4[p]</b> <u>base chance</u> to increase the targets' DoT taken by <color style='color:#f29e38;'><b>#2[p]</b></color> for <b>#3[f]</b> turn(s).",
            "Params": [
                [
                    0.96,
                    0.2,
    ...
    "110804": {
        "Pre": {
            ...
            "Type": "Talent",
            "Tag": "Enhance",
            "Desc": "Sampo's attacks have a <b>#1[p]</b> <u>base chance</u> to inflict Wind Shear for <b>#3[f]</b> turn(s).<br>Enemies inflicted with Wind Shear will take Wind DoT equal to <color style='color:#f29e38;'><b>#2[p]</b></color> of Sampo's ATK at the beginning of each turn. Wind Shear can stack up to <b>#4[f]</b> time(s).",
            "Params": [
                [
                    0.65,
                    0.2,
    ...
    "110807": {
        "Pre": {
            ...
            "Type": "Technique",
            "Tag": "Impair",
            "Desc": "After Sampo uses his Technique, enemies in a set area are inflicted with Blind for <b>#1[f]</b> second(s). Blinded enemies cannot detect your team.<br>When initiating combat against a Blinded enemy, there is a <b>#2[p]</b> <u>fixed chance</u> to delay all enemies' action by <b>#3[p]</b>.",
            "Params": [
                [
                    10.0,
                    1.0,
    ...
    "1108": {
        "Pre": {
            ...
            "Tree2": {
                ...
                "Desc": "Using Ultimate additionally regenerates <b><color style='color:#f29e38'>10.0</color></b> Energy.",
                "Icon": "SkillIcon_1108_SkillTree2"
            },
            "Tree3": {
                "Name": "Spice Up",
                "Desc": "Enemies with Wind Shear effect deal <b><color style='color:#f29e38'>15.0%</color></b> less DMG to Sampo.",
                "Icon": "SkillIcon_1108_SkillTree3"
            },
            "Tree1": {
                "Name": "Trap",
                "Desc": "Extends the duration of Wind Shear caused by Talent by <b><color style='color:#f29e38'>1.0</color></b> turn(s).",
...
var _avatarrank_ = {
    "110801": {
        "Pre": {
            "Rank": 1,
            "Name": "Rising Love",
            "Desc": "When using Skill, deals DMG for <b><color style='color:#f29e38'>1.0</color></b> extra time(s) to a random enemy.",
    ...
    "110802": {
        "Pre": {
            ...
            "Desc": "Defeating an enemy with Wind Shear has a <b><color style='color:#f29e38'>100.0%</color></b> base chance to inflict all enemies with <b><color style='color:#f29e38'>1.0</color></b> stack(s) of Wind Shear, equivalent to the Talent's Wind Shear.",
    ...
    "110804": {
        "Pre": {
            ...
            "Desc": "When Skill hits an enemy with <b><color style='color:#f29e38'>5.0</color></b> or more stack(s) of Wind Shear, the enemy immediately takes <b><color style='color:#f29e38'>8.0%</color></b> of current Wind Shear DMG.",
    ...
    "110806": {
        "Pre": {
            ...
            "Desc": "Talent's Wind Shear DMG multiplier increases by <b><color style='color:#f29e38'>15.0%</color></b>.",
