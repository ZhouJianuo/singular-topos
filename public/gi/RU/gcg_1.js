...
var _card = [
    ...
    [
        ...
        {
            "_id": 423049,
            "Name": "Талисман мастерства: Наведённый фокус",
        ...
        },
        {
            "_id": 323005,
            "Name": "Сундук семян",
            "Desc": "<color style='color:#FFFFFFFF'>Когда вы разыгрываете карту экипировки или поддержки с изначальной стоимостью в 1 дайс:</color> расходуется на 1 дайс меньше (1 раз за раунд).<br><color style='color:#FFFFFFFF'><color style='color:#FFFFFFFF'>Кол-во применений</color>: 2</color>",
            "Tag": [
                "GCG_TAG_ITEM"
            ],
    ...
    [
        ...
        {
            "_id": 224041,
            "Name": "Пульсация Электро цицина",
            "Desc": "<color style='color:#FFFFFFFF'>Боевое действие</color>: Эта карта экипируется, когда вашим активным персонажем является <color style='color:#FFFFFFFF'>Фатуи: Маг Электро цицинов</color>.<br>Когда Фатуи: Маг Электро цицинов экипирует эту карту, сразу используется <color style='color:#FFD780FF'>Зов в тумане</color>.<br>Когда Фатуи: Маг Электро цицинов с этой картой на поле боя и до того, как вы выберете действие: если <color style='color:#FFFFFFFF'>Электро цицин</color> имеет не менее 3 ед. <color style='color:#FFFFFFFF'>Кол-во применений</color>, то он наносит [b]2104[a]<color style='color:#FFACFFFF'>Электро урон</color>, 1 ед. <color style='color:#FFFFFFFF'>Кол-во применений</color> расходуются, 1 раз за раунд.<br>Чтобы добавить эту карту в колоду, там уже должна быть карта Фатуи: Маг Электро цицинов.",
            "Tag": [
                "GCG_TAG_TALENT",
                "GCG_TAG_SLOWLY"
            ],
    ...
    [
        ...
        {
            "_id": 330007,
            "Name": "День сопротивления: Разбитые мечты",
        ...
        },
        {
            ...
            "Desc": "<color style='color:#FFFFFFFF'>Карту можно разыграть только в том случае, когда у вас осталось не менее 8 дайсов, а противник ещё не объявил конец раунда:</color> в этом раунде стоимость смены персонажа для обоих участников увеличится на 1 дайс.",
            "Tag": [],
